...
1. Implement a pipeline function that returns a Hera `Workflow` object (see [Pipeline definition](../../reference/runtimes/hera/define-pipeline.md) for detailed instructions on creating pipeline functions).
...
- [Hera Build Action](../../reference/runtimes/hera/actions/hera-build.md) — Build pipeline definition in Argo YAML format
- [Hera Pipeline Action](../../reference/runtimes/hera/actions/hera-pipeline.md) — Execute the built pipeline on the platform
