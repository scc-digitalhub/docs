...
1. Implement a Python function (see [Function definition](../../reference/runtimes/python/guardrail/define-function.md) for detailed instructions on creating guardrail handlers).
