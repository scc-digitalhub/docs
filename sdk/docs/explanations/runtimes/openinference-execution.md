...
1. Implement a Python function (see [Function definition](../../reference/runtimes/python/openinference/define-function.md) for detailed instructions on creating Python, guardrail, and openinference handlers).
