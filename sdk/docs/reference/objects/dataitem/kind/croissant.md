...
| --- | --- | --- | --- |
| [`path`](../../../configuration/paths.md#scheme-specific-paths) | *str* | Path to the Croissant dataset location, a directory or partition containing `metadata.json`. | *required* |
