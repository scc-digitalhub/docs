...
| [replicas](../../../configuration/kubernetes/overview.md#replicas) | int | Number of replicas. Must be non-negative. |
| [service_ports](../../../configuration/kubernetes/overview.md#service-port-and-type) | list[dict] | Ports to expose for the service. Each port and target port must be an integer. Example: `[{"port": 80, "target_port": 8080}]`. |
| [service_type](../../../configuration/kubernetes/overview.md#service-port-and-type) | str | Service type: `ClusterIP`, `LoadBalancer`, `NodePort` or `ExternalName`. |
