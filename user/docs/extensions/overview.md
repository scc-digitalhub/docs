...
Typical scenarios for the extensions include, but are not limited to:

- provide the way to extend the data entities with extra metadata regarding data validation and profiling, such as, profiling report, data validation test results;
